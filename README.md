...
- **Фильтрует по стеку** — Playwright, TypeScript, Python, QA
- **Убирает мусор** — джуны, офис, DevOps, Java
...
Это не «скрипт на коленке». Внутри:
- Модульная архитектура (парсеры, фильтры, хранилище)
- База данных с защитой от дублей
- Умные фильтры (не ловят JavaScript как Java)
- Логирование, тесты, обработка ошибок
- Работа 24/7 с лимитами и паузами

**Продукт, а не пет-проект.**
...
- **Фильтры неочевидны** — «JavaScript» содержит «Java», «удалёнка» может быть написана 10 способами.
- **Лимиты и защита** — Telegram и сайты не любят автоматизацию. Нужны паузы, ротация.
- **Надёжность** — бот должен работать 24/7, не падать, не слать дубли, не терять данные.

**Это мини-продукт с архитектурой, базой данных, логированием и тестами.**
